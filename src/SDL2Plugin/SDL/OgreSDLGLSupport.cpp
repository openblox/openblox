...
void SDLGLSupport::addConfig(void){
	//We are going to use the SDL window and context already created by OpenBlox.
	/*
...
RenderWindow* SDLGLSupport::newWindow(const String &name, unsigned int width, unsigned int height, bool fullScreen, const NameValuePairList *miscParams){
