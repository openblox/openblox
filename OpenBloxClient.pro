...
HEADERS += engine/raknet/*.h engine/src/ob_lua/*.h engine/src/openblox/*.h engine/src/openblox/instance/*.h engine/src/openblox/type/*.h #src/openblox/*.h
SOURCES += engine/raknet/*.cpp engine/src/ob_lua/*.cpp engine/src/openblox/*.cpp engine/src/openblox/instance/*.cpp engine/src/openblox/type/*.cpp src/openblox/*.cpp
CONFIG += c++11
